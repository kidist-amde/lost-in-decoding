...
# -----------------------------------------------------------------------------
# RQ RUN PRESETS (uncomment ONE block at a time, run sequentially)
#
# RQ1(i) Effectiveness (Table 1-style: MSMARCO/TREC DL metrics)
# task="lexical_constrained_retrieve_and_rerank"
# lexical_constrained="lexical_tmp_rescore"   # options: lexical_condition | lexical_incorporate | lexical_tmp_rescore
#
# RQ1(ii) Decoding efficiency / beam-size trade-offs (Table 3-style)
# task="constrained_beam_search_for_doc_ret_by_sub_tokens"   # sweeps beam size x prefix length (eval only)
# task="constrained_beam_search_for_qid_rankdata_sub_tokens" # alternative sweep using sub-token qrels
#
# RQ1(iii) Ablations: sequential-only vs joint lexical+sequential
# task="constrained_beam_search_for_qid_rankdata"            # sequential-only baseline
# task="lexical_constrained_retrieve_and_rerank"             # joint model; change lexical_constrained above per run
#
