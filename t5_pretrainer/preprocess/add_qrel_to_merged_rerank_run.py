...
teacher_score_path = "<PATH_TO_WORKDIR>/data/msmarco/hard_negatives_scores/cross-encoder-ms-marco-MiniLM-L-6-v2-scores.pkl.gz"
with gzip.open(teacher_score_path, "rb") as fin:
    qid_to_reldocid_to_score = pickle.load(fin)
    
qrel_path = "<PATH_TO_WORKDIR>/data/msmarco/train_queries/qrels.json"
with open(qrel_path) as fin:
    qid_to_reldocids = ujson.load(fin)

qid_to_rerank = {}
rerank_path = "<PATH_TO_WORKDIR>/term_generative_retriever/experiments-dense/t5-full-dense-1-5e-4-12l/out/MSMARCO_TRAIN/qrel_added_merged_teacher_scores.json"
...
rerank_path_2 = "<PATH_TO_WORKDIR>/term_generative_retriever/experiments-term-encoder/t5-term-encoder-0/out/MSMARCO_TRAIN/qid_docids_teacher_scores.train.json"
...
with open("<PATH_TO_WORKDIR>/term_generative_retriever/experiments-dense/t5-dense-1/out/MSMARCO_TRAIN/qrel_added_merged_teacher_scores.json", "w") as fout:
