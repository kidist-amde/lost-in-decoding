...
qid_to_rerank = {}
rerank_path = "<PATH_TO_WORKDIR>/data/msmarco/bm25_run/qid_docids_teacher_scores.train.json"
...
with open("<PATH_TO_WORKDIR>/data/msmarco/bm25_run/qrel_added_qid_docids_teacher_scores.train.json", "w") as fout:
